			...
			<table class="table table-bordered table-hover table-condensed manage">
				...
				<thead class="active-header">
					<tr>
						...
						<th class="th-align">Description</th>
					...
					<?php foreach($data_grid as $item): ?>
						<tr>
							...
							<td class="text-center col-lg-2">
								<a href="<?php echo base_url('group/edit/'.$item->id.'/'); ?>" class="btn btn-primary btn-info btn-xs">
									<span class="glyphicon glyphicon-edit"></span> Edit
								</a>
								<a href="<?php echo base_url('group/delete/'.$item->id.'/'); ?>" class="btn btn-primary btn-danger btn-xs">
...
<div><a href="<?php echo base_url('group/add'); ?>" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Group</a></div>
