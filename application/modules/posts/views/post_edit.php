	                ...
	                <!-- Form Content -->
       		        <form id="form-validation" class="form-horizontal" method="post">
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-11">
                       		    <input type="text" id="post_title" name="post_title" class="form-control" placeholder="Post Title" value="<?php echo $post_title; ?>">
							</div><br />
       		            </div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-3">
                       		    <input type="text" id="post_type" name="post_type" class="form-control" placeholder="Post Type" value="<?php echo $post_type; ?>">
	                        </div>

							<label class="col-xs-1 control-label" for="post_amount">Amount:</label>
							<div class="col-xs-3">
                       		    <input type="text" id="post_amount" name="post_amount" class="form-control" placeholder="Post Amount" value="<?php echo $post_amount; ?>">
	                        </div>

							<label class="col-xs-1 control-label" for="post_currency">Currency:</label>
							<div class="col-xs-3">
                       		    <input type="text" id="post_currency" name="post_currency" class="form-control" placeholder="Post Currency" value="<?php echo $post_currency; ?>"><br />
	                        </div>
       		            </div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-7">
                      		    <input type="text" id="post_pic" name="post_pic" class="form-control" placeholder="Post Picture" value="<?php echo $post_pic; ?>">
	       		            </div>
