...
<p>
    ...
    <!-- Form Add User with Blocks in the Grid -->
                ...
                <form id="form-validation" method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="user_name" name="user_name" class="form-control" placeholder="Username" value="<?php echo set_value('user_name'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" name="add" value="add"><i class="fa fa-power-off"></i> Add User</button>
                    </div>
