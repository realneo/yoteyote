	                ...
	                <!-- Form Content -->
       		        <form id="form-validation" class="form-horizontal" method="post">
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-5">
                       		    <input type="text" id="page_title" name="page_title" class="form-control" placeholder="Page Title" value="<?php echo set_value('page_title'); ?>">
							</div>

							<label class="col-xs-1 control-label" for="page_headline">Headline:</label>
							<div class="col-xs-5">
   	                   		    <input type="text" id="page_headline" name="page_headline" class="form-control" placeholder="Page Headline" value=""><br />
	                        </div>
       		            </div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-5">
                       		    <input type="text" id="page_keywords" name="page_keywords" class="form-control" placeholder="Meta Keywords" value="">
	                        </div>

							<label class="col-xs-1 control-label" for="page_description">Description:</label>
							<div class="col-xs-5">
                       		    <input type="text" id="page_description" name="page_description" class="form-control" placeholder="Meta Description" value=""><br />
	                        </div>
       		            </div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-xs-3">
                      		    <input type="text" id="page_location" name="page_location" class="form-control" placeholder="Page Location" value="">
	       		            </div>

							<label class="col-xs-1 control-label" for="page_type">Type:</label>
							<div class="col-xs-3">
                       		    <input type="text" id="page_type" name="page_type" class="form-control" placeholder="Page Type" value=""><br />
	                        </div>
						...
						<div class="form-group">
							...
							<div class="col-xs-11">
								<textarea id="page_content" name="page_content" class="ckeditor"></textarea><br />
							</div>
						</div>

               		    <div class="form-group">
                       		<button type="submit" class="btn btn-primary" name="add" value="add"><i class="fa fa-power-off"></i> Add Page</button>
	                    </div>
