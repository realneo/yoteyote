...
<html>
    ...
    <body>
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#will_form">I Will </button>
-->

        <!-- Modal -->
        <div class="modal fade" id="will_form" tabindex="-1" role="dialog" aria-labelledby="iWillLable" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title text-success" id="iWillLable">I Will</h4>
                    </div>
                    <div class="modal-body">
                        <div class="input-group well">
                            <span class="input-group-addon text-success">I Will</span>
                        ...
                        <div class="input-group col-lg-5">
                            <span class="input-group-addon text-success">Tshs</span>
