			...
			<p>
				...
				<form id="form-validation" class="form-horizontal" method="post">
					...
					<div class="form-group">
						...
						<div class="col-xs-11">
							<textarea id="comment_content" name="comment_content" class="ckeditor"></textarea><br />
						</div>
					</div>

					<div class="form-group">
						<button type="submit" class="btn btn-primary" name="add" value="add"><i class="fa fa-power-off"></i> Add Comment</button>
					</div>
