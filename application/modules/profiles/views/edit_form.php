...
<div class="col-lg-6">
	<div class="panel panel-default">
	  	...
	  	<div class="panel-heading"><h3 class="panel-title">Edit User Profile</h3></div>
			...
			<div class="panel-body">
				<fieldset>
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" name="user_name" class="form-control" id="user_name" placeholder="User name" value="<?php echo set_value('user_name', $user_name); ?>">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" class="form-control" id="user_email" name="user_email" placeholder="Email" value="<?php echo set_value('user_email', $user_email); ?>">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							<button type="submit" class="btn btn-primary" name="profile" value="Update User Profile">
								<span class="glyphicon glyphicon-pencil"></span> Update User Profile
					  		</button>
						</div>
					</div>
				</fieldset>
