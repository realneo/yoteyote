 ...
 */
 ...
 function createTicker(file,hash_id) {
	 //setTimeout('pricetikcer()',
	 
	 var domain_name = document.domain;
	
	var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['create']});
//	var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['create']});
	service.create({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						// alert("result" + result);
						 //alert(result);
						 
						 if(result == 'NO_SUCH_SETTING_FILE') {
							  alert('No such setting file exists');
						 } else if(result == 'NO_PERMISSION') {
							 alert('You Doesnt Have Permission to Access this Gold Ticker');
						 } else {
							 document.getElementById('goldTickerCont').innerHTML = result;
//							 setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
						 //alert("Failure becausek1" + errorObj);
					  },
 ...
 function createTickerNoHash(file) {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['create']});
...
//							 setInterval ( "priceTicker()", 300000);
					  ...
					  onException:function(errorObj){
						// alert("Failure becausek" + errorObj);
					  },
					  onComplete:function(responseObj){
						 //any 'final' logic
...
function createMetalTickerNoHash(file) {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createmetal']});
//	var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createmetal']});
	service.createmetal({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						 //alert("The Result is" + result);
						 //alert(result);
						 ...
						 if(result == 'NO_SUCH_SETTING_FILE') {
							 ...
							 document.getElementById('metalTickerCont').innerHTML = result;
//							 setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
...
function createXPDTickerNoHash() {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	file = 'XPD';
	...
	service.createmetal({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						 ...
						 if(result == 'NO_SUCH_SETTING_FILE') {
							 ...
							 document.getElementById('xpdTickerCont').innerHTML = result;
//							 setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
...
function createXPDTicker(file) {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	//file = 'XPD';
	var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createxpd']});
//	var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createxpd']});
	service.createxpd({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						 //alert("The Result is" + result);
						 //alert(result);
						 ...
						 if(result == 'NO_SUCH_SETTING_FILE') {
							 ...
							 document.getElementById('xpdCustomTickerCont').innerHTML = result;
//							 setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
...
function createXPTTickerNoHash() {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	file = 'XPT';
	...
	service.createmetal({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						 ...
						 if(result == 'NO_SUCH_SETTING_FILE') {
							 ...
							 document.getElementById('xptTickerCont').innerHTML = result;
//							 setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
...
function createXPTTicker(file) {
	 //setTimeout('pricetikcer()',
	 var domain_name = document.domain;
	 hash_id = '0';
	//file = 'XPT';
	var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createxpt']});
//	var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createxpt']});
	service.createxpt({params:[file,hash_id,domain_name],
					  onSuccess:function(result){
						 //alert("The Result is" + result);
						 //alert(result);
						 ...
						 if(result == 'NO_SUCH_SETTING_FILE') {
							 ...
							 document.getElementById('xptCustomTickerCont').innerHTML = result;
							// setInterval ( "priceTicker()", 300000);
						 }
					  },
					  onException:function(errorObj){
...
function createSilverTicker(file,hash_id) {
	 //setTimeout('pricetikcer()',
	 
	 var domain_name = document.domain;
	 
var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createsilver']});
// var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['createsilver']});
service.createsilver({params:[file,hash_id,domain_name],
                  onSuccess:function(result){
                     //alert("The Result is" + result);
					 //alert(result);
					 ...
					 if(result == 'NO_SUCH_SETTING_FILE') {
					     ...
					     document.getElementById('silverTickerCont').innerHTML = result;
						 
					 }
                  },
                  onException:function(errorObj){
                     //alert("Failure because" + errorObj);
                  },
                  onComplete:function(responseObj){
                     //any 'final' logic
...
function createSilverTickerNoHash(file) {
	 //setTimeout('pricetikcer()',
...
//		var service = new rpc.ServiceProxy("http://173.193.121.106/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['price']});
		var service = new rpc.ServiceProxy("http://goldalert.com/rpc-server/rp_server.php", {asynchronous:true,sanitize:false,methods: ['price']});

service.price({params:[],
                  onSuccess:function(result){
                     //alert("The Result is" + result);
					 //alert(result);
				 if(document.getElementById('change').style.color!='gold'&& document.getElementById('change').style.color!='white'){
					 if(result[3] == 'green') {
						 result[1] = '+'+result[1];
						 result[2] = '+'+result[2];
						 document.getElementById('change').style.color='green';
						 document.getElementById('change_percent').style.color='green';
					 } else {
						 document.getElementById('change').style.color='red';
						 document.getElementById('change_percent').style.color='red';
					 }
				}
					 document.getElementById('price').innerHTML = ''+result[0];
					 document.getElementById('change').innerHTML = result[1];
					 document.getElementById('change_percent').innerHTML = '('+result[2]+'%)';
