<div class="modal fade" id="i_want_modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                   
                    <div class="modal-header red_bg">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title white_text lighter-text">Create "I Want" Post</h4>
                    </div><!-- modal-header -->
                    <form name='want_form' action='process/add_post_process.php' method='post'>
                    <div class="modal-body">
                       <div class='row'>
                           <div class='col-md-12'>
                              <div class='col-md-12'>
                                  <div class="input-group">
                                        <span class="input-group-addon red_text bolder-text">I Want</span>
                               ...
                               <div class='col-md-6'>
                                   ...
                                   <div class='col-md-6'>
                                       <div class="input_styled inlinelist">
                                            <div class="pull-left">
                                                <input type="radio" name="post_currency" value="Tshs" checked='checked' id='post_currency3'>
                                                <label for="post_currency3">TSH</label>
                                                <input type="radio" name="post_currency" value="USD" id='post_currency4'>
                                                <label for="post_currency4">USD</label>
                                            </div>
                                        </div>
                                   </div>
					   ...
					   <input type='hidden' value='want' name='post_type' />
                    </div><!-- modal-body -->
