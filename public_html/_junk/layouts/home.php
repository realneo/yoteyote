            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="<?php echo base_url('home/page_comp_charts'); ?>" class="header-link">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="<?php echo base_url('home/page_special_timeline'); ?>" class="header-link">
                                    <h1 class="animation-pullDown">7<br><small>Updates</small></h1>
                                </a>
                            </div>
                            <div class="col-xs-6">
                                <a href="<?php echo base_url('home/page_special_message_center'); ?>" class="header-link">
...
<?php echo $template['active_page']; ?>
            ...
            <div class="block full">
                ...
                <!-- Update Status Form -->
                <form action="<?php echo base_url('home'); ?>" method="post" class="profile-status block-top" onsubmit="return false;">
                    ...
                    <ul class="timeline remove-margin">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <p class="clearfix">
                                        ...
                                        <a href="<?php echo base_url('home/page_special_user_profile'); ?>">John</a> would like to become friends!
                                    </p>
                        ...
                        <li class="text-right">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <p>
                                        <a href="<?php echo base_url('home/page_special_user_profile'); ?>">Michael</a> just uploaded an image in <a href="javascript:void(0)" class="btn btn-xs btn-primary">Secret Project</a>
                                    </p>
                        ...
                        <li class="text-right">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content"><a href="<?php echo base_url('home/page_ready_pricing_tables'); ?>">Upgrade your plan</a> and get 1 year for free!</div>
                            </div>
                        </li>
                        <li class="text-right">
                            <div class="timeline-item">
        ...
        <div class="col-md-6">
            ...
            <div class="block">
                <!-- Quick Stats Title -->
                <div class="block-title">
                    <h2 class="text-center"><i class="fa fa-suitcase"></i> Business Plan <small>Active - <a href="<?php echo base_url('home/page_ready_pricing_tables'); ?>">Upgrade?</a></small></h2>
                </div>
            ...
            <div class="block full">
                <div class="block-title">
                    <h2 class="text-center"><i class="glyphicon-charts"></i> Earnings / Sales <small>Last Week - <a href="<?php echo base_url('home/page_comp_charts'); ?>">In detail</a></small></h2>
                </div>
            ...
            <div class="block">
                ...
                <div class="content-text clearfix">
                    ...
                    <h3 class="push">
						<a href="<?php echo base_url('home/page_special_user_profile'); ?>">John Doe</a> <small><em>750 Followers</em></small>
					</h3>
