...
/*
	...
	public $config = array(
		...
		'script_path'		=> "/xampp/htdocs/yoteyote/",
		'web_path'			=> 'http://yoteyote.dev/',
		'web_path_admin'	=> 'http://yoteyote.dev/admin/',
		'log_error'			=> TRUE,
		'admin_email'		=> 'neo@yoteyote.com',
		'upload_dir'		=> 'uploads',
		'db_name'			=> 'yoteyote_db',
...
*/
	...
	public function sendContactMail( $email , $data  )
	{
		...
		{
			echo $this->display_msg('success','Email sent with success. Our Representative will	be in contact shortly');
		}
	}
